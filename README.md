...
This repo provides code for TextBO in "Bayesian optimization in language space: An eval-efficient AI self-improvement framework" (https://arxiv.org/abs/2511.12063) for ad optimization experiments.
- For the installation guide for the Twin-2k-500 dataset we utilize, please refer to https://github.com/TianyiPeng/Twin-2K-500-Mega-Study .
- For the agentic AI experiments, please refer to https://github.com/Enoch-H-Kang/GEPA_suite
